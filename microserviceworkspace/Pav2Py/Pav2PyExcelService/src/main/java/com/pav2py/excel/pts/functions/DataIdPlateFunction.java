...
public class DataIdPlateFunction extends AbstractFunction {

    public DataIdPlateFunction() {
       keysSet.add("Mode"); keysSet.add("Field"); keysSet.add("Min_Len_of_Value"); keysSet.add("Max_Len_of_Value");keysSet.add("DrawingNumber"); keysSet.add("Description"); keysSet.add("Write_Value");
