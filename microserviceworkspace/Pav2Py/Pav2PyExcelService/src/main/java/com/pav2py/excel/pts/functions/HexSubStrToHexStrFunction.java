 ...
 * @author WLH1KOR
 */
public class HexSubStrToHexStrFunction extends AbstractFunction {

    public HexSubStrToHexStrFunction() {
       keysSet.add("InputHexString"); keysSet.add("StartByte"); keysSet.add("StopByte");
    }
