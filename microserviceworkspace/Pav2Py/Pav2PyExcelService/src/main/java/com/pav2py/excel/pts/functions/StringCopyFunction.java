 ...
 * @author WLH1KOR
 */
public class StringCopyFunction extends AbstractFunction {

    public StringCopyFunction() {
         keysSet.add("Input_Str"); keysSet.add("StartIndex"); keysSet.add("EndIndex");keysSet.add("InputString");keysSet.add("StopIndex");
    }
