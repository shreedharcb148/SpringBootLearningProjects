...
public class DataAddDataStrFunction extends AbstractFunction {

    public DataAddDataStrFunction() {
       keysSet.add("Mode"); keysSet.add("Field"); keysSet.add("Description"); keysSet.add("Write_Value");
       keysSet.add("Min_Len_of_Value"); keysSet.add("Max_Len_of_Value");
