 ...
 * @author WLH1KOR
 */
public class DoIPUDSRawIniFunction extends AbstractFunction {
    public DoIPUDSRawIniFunction() {
        keysSet.add("Eth_Handle");keysSet.add("Source_Address");
        keysSet.add("Target_Address");keysSet.add("Vechicle_Discovery");
        keysSet.add("Timeout"); keysSet.add("Node_Type");keysSet.add("Application");keysSet.add("Mode");
