 ...
 * @author IXL1KOR
 */
public class KundendatFunction extends AbstractFunction {

    public KundendatFunction() {
        keysSet.add("Data_Mode");
        keysSet.add("Data_Format");
        keysSet.add("DataString1");
        keysSet.add("DataString2");
        keysSet.add("DataString3");
    ...
    public String processParams() {
        ...
        if (super.getOutPutParam() != null && !super.getOutPutParam().isEmpty()) {
            return super.getOutPutParam() + " = " + super.getName() + "(" + "globals(), " + processInputParams() + "," + "struct_type = " + "\"" + super.getOutPutParam() + "\"" + ")";
        }
